...
int main(int argc, char* argv[]){
	...
	std_divide();
	fprintf(stdout, "Starting Googlebot... You need to configure your database first. Beware:\n");
	fprintf(stdout, "The standard filetype for the database is a .csv with the site properties\n");
